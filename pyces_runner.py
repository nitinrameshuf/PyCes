...
def main(): 
 ...
 try: 
  if(File_type.lower() == "html"):
   ...
   src_path = get_src_path()
   base_path = get_base_path()
   args3 = 'dependency-check.bat -s '+ src_path + '\\' +' --project trial_project -o '+ base_path 
   base_path = get_base_path()
...
table td {
  ...
  <span id='tabby-5'>
  <div class='tabby-block tabby-sev-low'>
  <h3>CR Runner Output:</h3>
  <p>[Running the scanner at: """ + rule_type + """ severity]</p><br/>
  <pre>"""+ output5 + """</pre>
  </div>
  </span>
...
Web: www.nitinramesh.wordpress.com
*******************************
-------------------------------
"""
